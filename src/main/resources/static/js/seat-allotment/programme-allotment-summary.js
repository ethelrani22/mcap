document.addEventListener("DOMContentLoaded", async function() {
    ...
    document.getElementById('btn-back-manage').href = `/controller/admissions/manage?admissionWindowCode=${winCode}&roundType=${round === 'NONCUET' ? 'NON_CUET' : round}&phaseNo=${phase}`;
